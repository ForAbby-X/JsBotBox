...
var material = new THREE.MeshPhongMaterial({ color: 0x008e00, wireframe: true });
var Game = /** @class */ (function () {
    ...
    Game.prototype.init_start = function () {
        return __awaiter(this, void 0, void 0, function () {
            var light, cube, fly_mesh;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cube.rotateX(randFloat(0, 2 * Math.PI));
                        this.engine.add_object(cube);
                        return [4 /*yield*/, this.engine.load_gltf('models/fly/scene.gltf', 'fly')];
                    case 1:
                        fly_mesh = _a.sent();
                        ...
                        fly_mesh.dynamic = true;
                        fly_mesh.needsUpdate = true;
                        this.engine.add_object(fly_mesh);
                        return [2 /*return*/];
                }
            });
        });
